...
echo "# DESCRIPTION: test_program reads file output.txt using submit_async_read interface. When it has read some contents, print them to stdout. At the beginning, file output.txt is empty. Then start a process to echo a number from 1 to 15000 into output.txt. Finally, check if test_program has read all the number or not."
echo "#####################################################"
