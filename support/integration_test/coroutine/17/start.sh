...
echo "# DESCRIPTION: cs.cancel_accept() on fd with pending coroutine accept (no client). Accept coroutine suspended, cancel_accept called. Verifies API does not crash."
echo "#####################################################"
