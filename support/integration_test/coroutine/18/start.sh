...
echo "# DESCRIPTION: task<int> value propagation chain. Coroutine compute_value() returns 42 via co_return. Consumer use_value() co_awaits and verifies value via atomic flag."
echo "#####################################################"
