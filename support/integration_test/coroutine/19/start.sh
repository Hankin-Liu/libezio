...
echo "# DESCRIPTION: generator<int> multi-yield via number_sequence(1,5). Iterates 5 yields (1,2,3,4,5) via next()/value(). Verifies sum=15, count=5, exhaustion detected."
echo "#####################################################"
