...
echo "# DESCRIPTION: Frame pool exhaustion fallback. Spawns 50 coroutines exceeding default pool capacity (~24). Verifies fallback to heap allocation works without crash."
echo "#####################################################"
