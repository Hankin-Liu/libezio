...
echo "# DESCRIPTION: cs.clear_spawned() partial cleanup. Spawns both short-lived and long-running (sleep) coroutines, then clears spawned list. Verifies clear_done flag set without crash."
echo "#####################################################"
