...
echo "# DESCRIPTION: Notifier cross-thread coroutine resume. Coroutine sleeps 5ms simulating notification wait. Another thread fires notifier callback. Verifies notified flag and callback count >= 1."
echo "#####################################################"
