...
echo "# DESCRIPTION: Notifier cross-thread wakeup. Coroutine sleeps 5ms simulating notifier wait. Notifier fires from another thread. Verifies both callback_fired and coro_done flags."
echo "#####################################################"
