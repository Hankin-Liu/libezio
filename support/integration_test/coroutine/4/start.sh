...
echo "# DESCRIPTION: cs.cancel_read() on fd with pending coroutine read. Verifies coroutine resumes with -ECANCELED and fd state transitions PENDING->CANCELLING->NONE."
echo "#####################################################"
