...
echo "# DESCRIPTION: cs.run_in_loop() posts job to event loop from external thread. Coroutine awaits job completion via awaiter. Verifies job counter reaches 2."
echo "#####################################################"
