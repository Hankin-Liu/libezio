...
echo "# DESCRIPTION: Test submit_async_read interface for tcp fd. Create a tcp listener and a tcp connector. Connector sends 10000 random string to listener. Listener uses this interface to receive data. Check if listener can receive correctly!"
echo "#####################################################"
