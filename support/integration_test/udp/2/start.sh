...
echo "# DESCRIPTION: Test submit_async_read interface for udp. Create a udp server and a udp client. Server uses this interface to receive data. Client sends 10000 random string to server. Check if server can receive correctly!"
echo "#####################################################"
